...
(function () {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/Titanmusic/source/master/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://rawgit.com/Titanmusic/source/master/lang/en.json",
        chat: null,
        loadChat: loadChat,
        retrieveSettings: retrieveSettings,
        retrieveFromStorage: retrieveFromStorage,
        settings: {
            botName: "♪Tittan + Music ♪[Bot]",
            language: "english",
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + ":thumbsup:/" + lastplay.score.grabs + ":heart:/" + lastplay.score.negative + ":thumbsdown:.")
                }
                else {
